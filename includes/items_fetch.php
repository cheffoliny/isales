...
while($r=$res->fetch_assoc()){
    ...
    $thumb = $hasImage ? '<img src="includes/item_image_get.php?id='.$r['id'].'" style="max-height:40px;cursor:pointer" class="item-thumb" data-id="'.$r['id'].'" data-hasimage="1">'
        : '<div class="bg-secondary text-white text-center" style="width:40px;height:40px;line-height:40px;">-</div>';
